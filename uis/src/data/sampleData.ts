...
export const itemsMenuDeEjemplo: MenuItem[] = [
  {
    id: "ITEM-PICANHA-250",
    name: "Picanha 250g",
    category: "Meat",
...
export const locacionesDeEjemplo: Location[] = [
  {
    id: "LOC-MEDELLIN-01",
...
export const ventasDeEjemplo: SaleTransaction[] = [
  {
    id: "TXN-2024-15482",
  ...
  },
  {
    ...
    timestamp: new Date("2024-03-15T21:10:00"),
    waiterName: "Andrés Peña",
  },
];

export const desperdiciosDeEjemplo: WasteRecord[] = [
  {
    id: "WASTE-001",
    locationId: "LOC-MEDELLIN-01",
    itemId: "ITEM-FRIES",
  ...
  },
  {
    ...
    quantity: 1,
    reason: "Damage",
    cost: { USD: 0.8, COP: 3200 },
    timestamp: new Date("2024-03-15T22:30:00"),
